...
class LocationControllerTest {
    ...
    class SuccessCases {
        ...
        void updateName_success() throws Exception {
            // given
            LocationUpdateRequest request = new LocationUpdateRequest("안방");
    ...
    class FailureCases {
        ...
        void createLocation_invalidBody_returnsBadRequest() throws Exception {
            ...
            LocationCreateRequest invalidRequest = new LocationCreateRequest("", Location.AutoControlMode.SUGGESTION);
        ...
        void updateName_invalidBody_returnsBadRequest() throws Exception {
            LocationUpdateRequest invalidRequest = new LocationUpdateRequest(null);
