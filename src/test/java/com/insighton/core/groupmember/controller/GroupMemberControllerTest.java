...
class GroupMemberControllerTest {
    ...
    class SuccessCases {
        ...
        void getGroupMemberList_success() throws Exception {
            // given
            GroupMemberListResponse mockResponse = new GroupMemberListResponse(100L, 1L, "테스트유저", GroupMember.GroupRole.MEMBER);
        ...
        void getGroupMember_success() throws Exception {
            // given
            GroupMemberResponse mockResponse = new GroupMemberResponse(100L, 1L, 1L, GroupMember.GroupRole.MEMBER, "testName", "010-0000-0000", OffsetDateTime.now());
