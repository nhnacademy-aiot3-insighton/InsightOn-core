...
public final class ActuatorCommandPreset {
    ...
    private static final Map<String, Map<CommandType, CommandValueRule>> RULES = Map.of(
            // 에어컨
            "AIRCON", Map.of(
    ...
    public static Set<CommandType> getSupportedCommands(String actuatorType) {
    ...
    public static boolean isValidValue(String actuatorType, CommandType commandType, String value) {
        //구칙 자체가 없으면 null
    ...
    public static void validateCommandValues(String actuatorType, Map<String, Object> newState) { // 파라미터 enum -> String
